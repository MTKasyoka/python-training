...
if age>=18:
      licence=input("Do you have a drivers licence yes/no?")
      if licence=="yes":
...
student_score=input("Enter your student score")
...
trans_amount=input('Enter your transaction amount:')
account_type=input("Enter your account type standard or premium:")
...
if account_type=="premium":
    if trans_amount>1000:
        print('Transaction exceeds th limit for Premium accounts')
    else:
        print("Transaction approved")
